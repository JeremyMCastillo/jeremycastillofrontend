    ...
    return (
        <Layout>
            <div className="h-full pl-16 md:pl-80 grid grid-cols-1 lg:grid-cols-2 gap-8 pt-24">
                ...
                <form className="flex flex-col gap-8 bg-slate-50 dark:bg-blue-600 border border-blue-600 dark:border-slate-50 rounded-lg p-8 mr-16 shadow-lg" action="/api/contact" method="POST">
