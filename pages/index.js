  ...
  return (
    <Layout categories={categories}>
      ...
      <div className="md:pl-80 bg-slate-50 dark:bg-blue-600 h-full font-chivo pl-8">
        <h1
          className="text-blue-600 dark:text-slate-50 text-7xl sm:text-8xl py-28 pb-2 font-bold"
          dangerouslySetInnerHTML={{ __html: homepage?.hero.title || "" }}
        ></h1>
        <subtitle className="mb-48 block pl-2 pr-2 pt-4">
          {homepage?.subtitle || ""}
        </subtitle>
        <h2 className="text-blue-600 dark:text-slate-50 text-6xl font-bold font-chivo">
          My Work
        </h2>
